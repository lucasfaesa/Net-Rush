...
public class PlayersInstantiator : MonoBehaviour
{
    ...
    private void Awake()
    {
        PlayerController playerLeft = Instantiate(playerLeftPrefab, playerLeftPos, Quaternion.identity);
        PlayerController playerRight = Instantiate(playerRightPrefab, playerRightPos, Quaternion.identity);
